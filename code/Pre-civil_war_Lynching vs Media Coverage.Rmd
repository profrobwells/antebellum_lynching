...
#Sandwich it onto a simple ggplot
  ...
  labs(title = "Pre-Civil War Lynching Coverage By Year", 
       ...
       caption = "n=9,182 results. Peak page count: 1856: 1,139 articles. Graphic by Rob Wells, 12/19/2025",
       y="Count of Pages",
       x="Year")
...
ggsave("../output/coverage_year_12_19_2025.png", device = "png",width=9,height=6, dpi=800)
